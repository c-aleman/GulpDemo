<?php include 'partials/header.php';?>
	...
	<div class="hide md-block flex items-end h-90v bg-iso bg-cover bg-muiltiply">
		<div class="p-5">
		...
		<div class="flex">
			...
			<div class="w-full py">
					...
					<div class="mx-auto px-4 md-w-3/4 lg-w-3/4 mb-7">
						...
						<div class="big-mt-1">
							<h3 class="text-regular text-semi-bold">Utility Focused</h3>
							<p class="tracking-clean text-grey-dark leading-regular">With various utility classes at hand, its easy to customoize and set up new projects. Rapid prototyping to sketch out ideas can be faster with Snackpack's css classes. We at Snackpack develop with the user in mind, our naming choices are made easy so they can be quickly applied to your layout.</p>
						</div>

						<div class="big-mt-1">
							

							<div class="flex big-mt-1">

								<div class="w-1/3">
									<img class="block mx-auto icon-img" src="/images/phone.svg" alt="">
									<p class="text-center text-grey-light">sm</p>
								</div>

								<div class="w-1/3">
									<img class="block mx-auto icon-img" src="/images/tablet1.svg" alt="">
									<p class="text-center text text-grey-light">md</p>
								</div>
								<div class="w-1/3">
									<img class="block mx-auto icon-img" src="/images/comp1.svg" alt="">
									<p class="text-center text-grey-light">lg</p>
								</div>
							

							</div>
							<h3 class="text-regular text-semi-bold">Fully Responsive</h3>
							<p class="tracking-clean text-grey-dark leading-regular">Apply breakpoint tags to make your site fully responsive. Snackpack uses teh mobile first approach and then adds breakpoints for larger screens.</p>
						</div>
